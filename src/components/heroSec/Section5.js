...
function HeroSection5() {
    return (
        <div className='flex flex-row justify-center space-x-10 items-center m-10'>
            <div className='relative'>
                ...
                <div>
                    ...
                    <button className='bg-primary text-white px-8 py-2 font-semibold rounded-2xl absolute bottom-[6%] left-6'>Get Started</button>
                </div>
            </div>
            <div className='relative'>
                <img src={User} alt="User" className='relative h-[21rem] bg-secondary rounded-xl' />
                <div>
